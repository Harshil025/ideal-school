...
import section from "../images/banner2.png";
...
const Spoken = () => {
  ...
  return (
   ...
   <div className='section4'>
     <h1>An exclusive learning journey for Spoken English</h1>
    <h5 className="section5"><span><i class="fa-solid fa-quote-left"></i></span> Our language center offers group and personal lessons in English and other modern languages for all ages and levels of knowledge.</h5>
...
<div className='spoken8'>
    ...
    <h2 className='text-center'> Spoken English</h2>
   <h5 className='text-center'> Improve your English communication skills</h5>
   ...
   <div className='phase1 '>
                     ...
                     <p><i class="fa-solid fa-arrow-right"></i>  It develop the Basic Concept of English Language.</p>
                     ...
                     <p><i class="fa-solid fa-arrow-right"></i>  It polishes listening,reading & Writting skill.</p>
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="headingOne">
      ...
      What are the minimum requirements to learn spoken English Courses?
      </button>
    </h2>
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="headingTwo">
      ...
      Can anyone register  for the Spoken English Courses?
      </button>
    </h2>
