...
import section from "../images/pu6.png";
import man from "../images/man23.png";
...
const Public = () => {
  return (
   ...
   <div className='section41'>
     <h1>An exclusive learning journey for Public speaking</h1>
    <h5 className="section51"><span><i class="fa-solid fa-quote-left"></i></span> Our  center offers group and personal lessons in  public speaking and other for all ages and levels of knowledge.</h5>
...
<div className='spoken8'>
   ...
   <h5 className='text-center'> Improve your communication skills</h5>
   ...
   <div className='phase1 '>
                     ...
                     <p><i class="fa-solid fa-arrow-right"></i>  It develop the Basic Concept of Public Speaking.</p>
                     ...
                     <p><i class="fa-solid fa-arrow-right"></i>  This phase improve advance / news paper vocab and advanced Grammar...</p>
                     <p><i class="fa-solid fa-arrow-right"></i>  It polishes Expression of face , Speaking& Writting skill.</p>
                     ...
                     <img 
                        ...
                        src={conversation} />
                      <div className='phase2 '>
                     <h3 className="heading mb-3">PHASE3</h3>
                     ...
                     <p><i class="fa-solid fa-arrow-right"></i>  Its main focus on speaking fluency and prounciation.... </p> 
                     </div>
                     </div>
   </div>
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="headingOne">
      ...
      What are the minimum requirements to learn Public Speaking Courses?
      </button>
    </h2>
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="headingTwo">
      ...
      Can anyone register  for the Public Speaking Courses?
      </button>
    </h2>
    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
      <div class="accordion-body">
    Yes, anyone can register for the Public Speaking course
      </div>
    </div>
  </div>
